...
When auditing a site, map detected features to the closest package:

| Detected | Recommended | Why |
|---|---|---|
| 1 page only, basic | Student / Starter | depends on hosting need |
| 1 page + form + CTA, modern | Starter | most landing pages |
