---
name: Cold Outreach Central Java Jun 2026
description: 10 cold-outreach leads (cafe/salon/dental/gym/real-estate) across Central Java with IG handles, matched demo links, and per-lead ID message
metadata:
  type: project
---

Batch gathered 2026-06-11 for Rielcode cold outreach. 10 leads, Central Java, niches with ready demos at rielcode.com/demos/. Send via IG DM (manual, no WA deep-link), open in Opera per [[feedback_lead_message_opera]]. Real bottleneck is close not lead-gen [[feedback_close_gap_not_leadgen]]; demos fix the "got examples?" stall.

**VERIFIED 2026-06-11.** All 9 below have NO real website (only link-in-bio: linktr.ee/msha.ke/bit.ly/wa.link/ctcin.bio, or none). Link-in-bio = the gap to fill. Bento Kopi dropped (IG handle 404, account gone).

## Contacts (verified, ready to DM)

| # | Business | Niche | IG | Demo | Bio link |
|---|---|---|---|---|---|
| ~~1~~ | ~~Bento Kopi~~ | ~~Cafe~~ | ~~@bentokopi.salatiga~~ | ~~restaurant-cafe~~ | DEAD 404 |
| 2 | Koffiegoen | Cafe | @koffiegoen | restaurant-cafe | linktr.ee |
| 3 | KenKei Salon | Salon | @kenkeisalon | beauty-salon | msha.ke |
| 4 | Moiss Salon | Salon | @moissalon.smg | beauty-salon | bit.ly |
| 5 | Denticare | Dental | @denticare.clinic | dental-clinic | wa.link |
| 6 | Tito Dental Care | Dental | @tito_dental_care | dental-clinic | wa.link |
| 7 | Young Gym Salatiga | Gym | @younggymsalatiga | gym-fitness | none |
| 8 | TwinFit Gym | Gym | @twinfit_gym | gym-fitness | none |
| 9 | Enny C21 Platinum | Real estate | @ennyc21platinum | real-estate | ctcin.bio |
| 10 | Info Rumah Solo | Real estate | @jual_rumahsolo | real-estate | wa.me |
