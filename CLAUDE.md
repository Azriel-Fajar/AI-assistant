...
1. `/project-kickoff` -- templatized workflow to kick off new client projects
2. `/instagram-content` -- generate marketing content for Rielcode's Instagram
3. `/daily-priorities` -- surface what to do next based on priorities and deadlines
