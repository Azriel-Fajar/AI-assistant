...
## Corpus Check
- 564 files · ~4,478,955 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5283 nodes · 5393 edges · 698 communities (613 shown, 85 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 124 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `716f9863`
...
10. `Figma CLI Implementation Plan` - 16 edges

## Surprising Connections (you probably didn't know these)
- `tsStamp()` --calls--> `p`  [INFERRED]
  .claude/skills/quiz-auto/run.js → screenshots/_hero.js
- `periodToDates()` --calls--> `fmt()`  [INFERRED]
  tools/google/youtube/index.js → meta/dms-sync.mjs
- `parse_homework()` --rationale_for--> `Parse a natural-language homework message.     Returns {"subject": str, "due_da`  [EXTRACTED]
  C:/Users/afw14/OneDrive/Documents/JARVIS/homework-bot/homework_parser.py → homework-bot/homework_parser.py
...
## Communities (698 total, 85 thin omitted)
...
Cohesion: 0.6
Nodes (3): _clean_subject(), parse_homework(), Parse a natural-language homework message.     Returns {"subject": str, "due_da
...
Cohesion: 0.36
Nodes (9): build_panel(), find_latest_session(), git_info(), main(), pct_bar(), pct_color(), Return branch, repo name, dirty flag for given path., Scan $TEMP for claude-ctx-*.json files and return the most recently     modifie (+1 more)
...
Cohesion: 0.21
Nodes (9): AdBase(), AdProps, angles, LOGO_PATH, theme, adRatios, ids, promoSizes (+1 more)
...
Cohesion: 0.47
Nodes (9): _make_mock_service(), test_creates_three_events(), test_deadline_event_end_is_next_day(), test_deadline_event_is_allday(), test_result_has_correct_dates(), test_study_block1_has_reminder(), test_study_block2_no_reminder(), test_study_blocks_are_2hours() (+1 more)
...
Cohesion: 0.39
Nodes (7): test_parse_all_noise_subject(), test_parse_bad_date_returns_none(), test_parse_day_name(), test_parse_explicit_date(), test_parse_next_monday(), test_parse_no_date_returns_none(), test_parse_tomorrow()
...
Cohesion: 0.61
Nodes (6): build_service(), CalendarResult, create_homework_events(), _deadline_body(), _insert_event(), _study_block_body()
...
Cohesion: 0.27
Nodes (5): add_hit(), Get-ItemEvidence(), on_err(), on_exit(), Walk-Residue()
...
Cohesion: 0.5
Nodes (3): tsStamp(), { chromium }, p

### Community 625 - "Community 625"
Cohesion: 0.5
Nodes (3): { chromium }, hasForm, hasMeta
...
## Knowledge Gaps
- **2902 isolated node(s):** `0`, `1`, `2`, `3`, `4` (+2897 more)
...
- **Why does `MetaError` connect `Community 319` to `Community 25`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
