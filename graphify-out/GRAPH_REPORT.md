...
## Summary
- 2083 nodes · 2142 edges · 151 communities detected
...
4. `Figma CLI Implementation Plan` - 16 edges
5. `create_homework_events()` - 15 edges
6. `pay.rielcode.com Implementation Plan` - 15 edges
7. `Design` - 14 edges
8. `YouTube CLI Implementation Plan` - 14 edges
9. `Google CLI Design Spec` - 14 edges
10. `printTable()` - 13 edges
...
Cohesion: 0.03
Nodes (92): AIOS Intake, Free Website Audit Tool, Build-with-me Live Streams, Canva MCP Integration, Floating Chatbot Widget, Dark UI Design Theme, Decisions Log (decisions/log.md), DomPDF PDF Generation Engine (+84 more)
...
Cohesion: 0.08
Nodes (39): confirm(), deleteComment(), formatDate(), getAnalytics(), getCalendar(), getDrive(), getGmail(), getYouTube() (+31 more)
...
Cohesion: 0.11
Nodes (27): get_service_account_info(), build_service(), CalendarResult, create_homework_events(), _deadline_body(), _insert_event(), _study_block_body(), _clean_subject() (+19 more)
...
Cohesion: 0.14
Nodes (14): 1. Resolve project path, 2. Auto-scan the project, 3. Ask only for gaps, 4. Resolve sections to omit, 5. Build HTML, 6. Generate the PDF, 7. Notify, 8. Report (+6 more)
...
Cohesion: 0.18
Nodes (11): 1. Gather project details, 2. Create the project folder, 3. Generate the kickoff checklist, 4. Log the new project, 5. Offer a WhatsApp kickoff message, code:markdown (# <Client Name> -- <Project Type>), code:block2 (Kickoff Checklist -- <Client Name>), code:block3 ([<today's date>] DECISION: Started project for <Client Name>) (+3 more)
...
Cohesion: 0.22
Nodes (9): 1. Read context, 2. Build the action list, 3. Output format, 4. Send ntfy notification, 5. Ask if the user wants to act on anything, code:bash (curl -s -o /dev/null -H "Title: Daily Priorities Ready" -d "), Rules, Steps (+1 more)
...
## Knowledge Gaps
- **1152 isolated node(s):** `Parse a natural-language homework message.     Returns {"subject": str, "due_da`, `Set up dummy environment variables for testing.`, `Return branch, repo name, dirty flag for given path.`, `Scan $TEMP for claude-ctx-*.json files and return the most recently     modified`, `Parse a natural-language homework message.     Returns {"subject": str, "due_da` (+1147 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 104`** (2 nodes): `runBrowser()`, `cross-browser-template.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `connections.md`, `Connections`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `connections.md`, `Connections`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (2 nodes): `Four Cs AIOS Audit Framework`, `Skill: audit (Four Cs AIOS Audit)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (1 nodes): `playwright.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `rielcode-review.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `fill-custom-plan-pro.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `gform-answer-all.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `gform-answer.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (1 nodes): `gform-login.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `gform-probe-all.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (1 nodes): `gform-q1.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (1 nodes): `inspect-padding.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `order-form-debug.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `order-form-smtp-test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `order-form-test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (1 nodes): `order-form-test2.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (1 nodes): `order-form-test3.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `order-form-test4.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (1 nodes): `order-form-test5.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 125`** (1 nodes): `order-form-verify-fix.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (1 nodes): `order-form-verify.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (1 nodes): `track1c-screenshots.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (1 nodes): `smoke.spec.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (1 nodes): `launch-widget.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (1 nodes): `error.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 131`** (1 nodes): `figma.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 132`** (1 nodes): `output.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (1 nodes): `jest.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (1 nodes): `youtube.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 135`** (1 nodes): `auth.instagram.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (1 nodes): `auth.tiktok.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (1 nodes): `error.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (1 nodes): `ig.list.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (1 nodes): `output.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (1 nodes): `tt.list.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (1 nodes): `Parse a natural-language homework message.     Returns {"subject": str, "due_da`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (1 nodes): `Set up dummy environment variables for testing.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 143`** (1 nodes): `Return branch, repo name, dirty flag for given path.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (1 nodes): `Scan $TEMP for claude-ctx-*.json files and return the most recently     modifie`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 145`** (1 nodes): `_COMMUNITY_Community 5.md`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 146`** (1 nodes): `CLAUDE.local.md Local Overrides`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 147`** (1 nodes): `Session Summary Template`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 148`** (1 nodes): `Rielcode Portfolio Page Screenshot v2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (1 nodes): `Rielcode Portfolio Page Screenshot v3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (1 nodes): `Rielcode Services Page Screenshot v2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **What connects `Parse a natural-language homework message.     Returns {"subject": str, "due_da`, `Set up dummy environment variables for testing.`, `Return branch, repo name, dirty flag for given path.` to the rest of the system?**
