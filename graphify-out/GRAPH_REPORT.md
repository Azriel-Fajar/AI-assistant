# Graph Report - JARVIS  (2026-06-11)

## Corpus Check
- 483 files · ~2,863,610 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4701 nodes · 4902 edges · 573 communities (513 shown, 60 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 109 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `421cb4cd`
...
4. `Azriel's Executive Assistant` - 19 edges
5. `log()` - 18 edges
...
## Communities (573 total, 60 thin omitted)
...
## Knowledge Gaps
- **2591 isolated node(s):** `0`, `1`, `2`, `3`, `4` (+2586 more)
...
- **Why does `get()` connect `Community 1` to `Community 0`, `Community 3`, `Community 5`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `MetaError` connect `Community 111` to `Community 4`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `MetaError` connect `Community 1` to `Community 4`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
